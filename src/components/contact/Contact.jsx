...
function Contact() {
  ...
  const successMessage = (
    ...
    >
      ...
      <h2>Success! Your message has been sent seccesfully</h2>
    </motion.div>
  );
  ...
  const errorMessage = (
    ...
    >
      ...
      <h2>Error! A problem has accured while submitting your message </h2>
    </motion.div>
  );
  ...
  return (
    ...
    >
      <motion.div className="textContainer" variants={variants}>
        ...
        <motion.div className="item" variants={variants}>
          <h2>Address</h2>
          <a href="#">El mostakbal Gh05 Im 36 Casa</a>
        </motion.div>
        <motion.div className="item" variants={variants}>
          <h2>Phone</h2>
